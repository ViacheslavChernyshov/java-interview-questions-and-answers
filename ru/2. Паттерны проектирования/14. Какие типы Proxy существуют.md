...
**Связанные темы:**
- [В чём преимущество Decorator перед наследованием](12.%20В%20чём%20преимущество%20Decorator%20перед%20наследованием.md) — Proxy vs Decorator
- [Как реализован Observer в Java](11.%20Как%20реализован%20Observer%20в%20Java.md) — Spring Events через Proxy
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — Structural паттерны
- [Какие антипаттерны вы знаете](16.%20Какие%20антипаттерны%20вы%20знаете.md) — Poltergeist (лишний уровень косвенности)
- [Что такое паттерны проектирования](1.%20Что%20такое%20паттерны%20проектирования.md) — Proxy в Spring AOP
