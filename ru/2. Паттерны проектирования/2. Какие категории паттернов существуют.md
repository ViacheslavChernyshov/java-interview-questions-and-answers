...
DIP (Dependency Inversion Principle) — принцип инверсии зависимостей: завись от абстракций, не от деталей.
OCP (Open/Closed Principle) — принцип открытости/закрытости: открыт для расширения, закрыт для модификации.
...
- В Modern Java: Factory Method заменяется Supplier<T>, Singleton — DI-контейнером (Spring @Component)
...
**Связанные темы:**
- [Что такое паттерны проектирования](1.%20Что%20такое%20паттерны%20проектирования.md) — общее введение и уровни паттернов
- [Что такое Singleton](3.%20Что%20такое%20Singleton.md) — Creational паттерн
- [В чём преимущество Decorator перед наследованием](12.%20В%20чём%20преимущество%20Decorator%20перед%20наследованием.md) — Structural паттерн
- [Когда использовать Strategy](10.%20Когда%20использовать%20Strategy.md) — Behavioral паттерн
- [Какие типы Proxy существуют](14.%20Какие%20типы%20Proxy%20существуют.md) — Structural паттерн в Spring
