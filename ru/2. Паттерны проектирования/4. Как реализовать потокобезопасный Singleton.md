...
- [Что такое double-checked locking](5.%20Что%20такое%20double-checked%20locking.md) — подробнее о DCL
...
- [Какие антипаттерны вы знаете](16.%20Какие%20антипаттерны%20вы%20знаете.md) — когда Singleton становится антипаттерном
