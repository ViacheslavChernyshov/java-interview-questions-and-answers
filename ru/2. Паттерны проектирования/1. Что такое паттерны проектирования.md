...
**Связанные темы:**
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — подробная классификация
- [Какие антипаттерны вы знаете](16.%20Какие%20антипаттерны%20вы%20знаете.md) — плохие решения, которые вредят коду
...
- [Когда использовать Strategy](10.%20Когда%20использовать%20Strategy.md) — поведенческие паттерны на практике
- [В чём преимущество Decorator перед наследованием](12.%20В%20чём%20преимущество%20Decorator%20перед%20наследованием.md) — композиция vs наследование
