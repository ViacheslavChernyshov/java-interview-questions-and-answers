...
**Паттерны проектирования** — это готовые, проверенные решения для типичных задач программирования.
...
- Простая задача решается `if-else`
- Нет планов расширения в будущем
- Паттерн усложняет код без выгоды
