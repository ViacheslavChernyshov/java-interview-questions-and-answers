...
**Связанные темы:**
- [Как реализовать потокобезопасный Singleton](4.%20Как%20реализовать%20потокобезопасный%20Singleton.md) — DCL как способ реализации
- [Что такое Singleton](3.%20Что%20такое%20Singleton.md) — общий контекст Singleton
- [Каковы проблемы с Singleton](6.%20Каковы%20проблемы%20с%20Singleton.md) — проблемы Singleton
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — Creational паттерны
- [Какие антипаттерны вы знаете](16.%20Какие%20антипаттерны%20вы%20знаете.md) — антипаттерны проектирования
