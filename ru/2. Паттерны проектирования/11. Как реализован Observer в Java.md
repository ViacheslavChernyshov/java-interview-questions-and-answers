...
**Связанные темы:**
- [Что такое Iterator pattern](15.%20Что%20такое%20Iterator%20pattern.md) — перебор коллекций
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — Behavioral паттерны
- [Какие типы Proxy существуют](14.%20Какие%20типы%20Proxy%20существуют.md) — Proxy в Spring Events
- [Когда использовать Strategy](10.%20Когда%20использовать%20Strategy.md) — замена алгоритмов
