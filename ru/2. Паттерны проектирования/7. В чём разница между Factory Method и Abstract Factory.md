...
**Связанные темы:**
- [Когда использовать Builder](8.%20Когда%20использовать%20Builder.md) — порождающий паттерн для сложных объектов
- [Что такое Prototype pattern](9.%20Что%20такое%20Prototype%20pattern.md) — порождающий паттерн копирования
- [Что такое паттерны проектирования](1.%20Что%20такое%20паттерны%20проектирования.md) — общее введение
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — Creational паттерны
- [Когда использовать Strategy](10.%20Когда%20использовать%20Strategy.md) — поведенческий паттерн, альтернатива через композицию
