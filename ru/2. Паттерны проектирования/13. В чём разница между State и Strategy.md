...
**Связанные темы:**
- [Когда использовать Strategy](10.%20Когда%20использовать%20Strategy.md) — основной паттерн Strategy
- [Что такое Iterator pattern](15.%20Что%20такое%20Iterator%20pattern.md) — перебор состояний
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — Behavioral паттерны
- [Какие антипаттерны вы знаете](16.%20Какие%20антипаттерны%20вы%20знаете.md) — Sequential Coupling
- [Что такое паттерны проектирования](1.%20Что%20такое%20паттерны%20проектирования.md) — Behavioral категория
