...
**Связанные темы:**
- [Что такое Singleton](3.%20Что%20такое%20Singleton.md) — общее описание паттерна
- [Как реализовать потокобезопасный Singleton](4.%20Как%20реализовать%20потокобезопасный%20Singleton.md) — безопасные реализации
- [Что такое double-checked locking](5.%20Что%20такое%20double-checked%20locking.md) — DCL оптимизация
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — Creational паттерны
- [Какие антипаттерны вы знаете](16.%20Какие%20антипаттерны%20вы%20знаете.md) — Singleton как антипаттерн
