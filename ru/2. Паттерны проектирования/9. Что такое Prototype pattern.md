...
**Связанные темы:**
- [Когда использовать Builder](8.%20Когда%20использовать%20Builder.md) — порождающий паттерн
...
- [Что такое Singleton](3.%20Что%20такое%20Singleton.md) — Singleton vs Prototype scopes
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — Creational паттерны
- [Какие антипаттерны вы знаете](16.%20Какие%20антипаттерны%20вы%20знаете.md) — Copy-Paste Programming
