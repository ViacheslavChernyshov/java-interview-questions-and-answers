...
- Spring auto-registry: List<Strategy> injection → автоматический Map<String, Strategy>
...
- **Как Spring автоматически регистрирует стратегии?** — List<Strategy> injection → Stream.collect(toMap)
...
**Связанные темы:**
- [В чём разница между State и Strategy](13.%20В%20чём%20разница%20между%20State%20и%20Strategy.md) — сравнение паттернов
- [Что такое паттерны проектирования](1.%20Что%20такое%20паттерны%20проектирования.md) — лямбды заменяют Strategy
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — Behavioral паттерны
- [Какие антипаттерны вы знаете](16.%20Какие%20антипаттерны%20вы%20знаете.md) — Golden Hammer
- [Какие типы Proxy существуют](14.%20Какие%20типы%20Proxy%20существуют.md) — альтернативный Structural подход
