...
**Связанные темы:**
- [Как реализован Observer в Java](11.%20Как%20реализован%20Observer%20в%20Java.md) — перебор слушателей
- [Какие категории паттернов существуют](2.%20Какие%20категории%20паттернов%20существуют.md) — Behavioral паттерны
- [Когда использовать Strategy](10.%20Когда%20использовать%20Strategy.md) — Stream API как альтернатива
- [Какие антипаттерны вы знаете](16.%20Какие%20антипаттерны%20вы%20знаете.md) — God Object с коллекциями
- [Что такое паттерны проектирования](1.%20Что%20такое%20паттерны%20проектирования.md) — Iterator в Modern Java
