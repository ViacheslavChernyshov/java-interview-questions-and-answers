...
См. также: [Что делает метод allOf() и когда его использовать](9.%20Что%20делает%20метод%20allOf()%20и%20когда%20его%20использовать.md), [Что делает метод anyOf() и в каких случаях он полезен](10.%20Что%20делает%20метод%20anyOf()%20и%20в%20каких%20случаях%20он%20полезен.md)
...
**Связанные темы:**
- [Что делает метод allOf() и когда его использовать](9.%20Что%20делает%20метод%20allOf()%20и%20когда%20его%20использовать.md)
...
- [В чём разница между thenApply() и thenCompose()](4.%20В%20чём%20разница%20между%20thenApply()%20и%20thenCompose().md)
