...
**Связанные темы:**
- [Что делает метод join() и чем он отличается от get()](25.%20Что%20делает%20метод%20join()%20и%20чем%20он%20отличается%20от%20get().md)
- [Как создать CompletableFuture, который уже завершён с результатом](3.%20Как%20создать%20CompletableFuture%2C%20который%20уже%20завершён%20с%20результатом.md)
