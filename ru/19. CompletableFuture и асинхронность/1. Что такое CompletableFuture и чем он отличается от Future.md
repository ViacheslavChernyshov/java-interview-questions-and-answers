...
**Связанные темы:**
- [Какие основные преимущества CompletableFuture перед Future](2.%20Какие%20основные%20преимущества%20CompletableFuture%20перед%20Future.md)
- [Какой пул потоков используется по умолчанию для async методов](12.%20Какой%20пул%20потоков%20используется%20по%20умолчанию%20для%20async%20методов.md)
...
- [Что делает метод supplyAsync() и когда его использовать](16.%20Что%20делает%20метод%20supplyAsync()%20и%20когда%20его%20использовать.md)
