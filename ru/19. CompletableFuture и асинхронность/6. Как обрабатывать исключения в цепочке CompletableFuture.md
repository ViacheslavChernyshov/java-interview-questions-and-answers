...
**Связанные темы:**
- [В чём разница между handle(), exceptionally() и whenComplete()](7.%20В%20чём%20разница%20между%20handle()%2C%20exceptionally()%20и%20whenComplete().md)
- [Что произойдёт, если в цепочке CompletableFuture возникнет исключение](18.%20Что%20произойдёт%2C%20если%20в%20цепочке%20CompletableFuture%20возникнет%20исключение.md)
