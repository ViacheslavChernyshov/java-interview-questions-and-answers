...
Kafka удаляет старые сообщения **по сегментам**, когда они становятся старше заданного retention периода. Не по одному сообщению, а целыми файлами (сегментами).
