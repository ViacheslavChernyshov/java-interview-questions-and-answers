...
- «Unclean leader election — безопасен» — данные потеряны при выборе несинхронного лидера

**Связанные темы:**
- [Что такое leader и follower реплики](17.%20Что%20такое%20leader%20и%20follower%20реплики.md)
- [Что такое ISR (In-Sync Replicas)](18.%20Что%20такое%20ISR%20(In-Sync%20Replicas).md)
