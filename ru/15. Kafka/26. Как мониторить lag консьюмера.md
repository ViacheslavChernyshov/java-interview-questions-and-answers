...
(эти значения зависят от throughput — lag нужно оценивать ВМЕСТЕ с producer rate.
Lag 1000 при 100 msg/s = 10 секунд отставания; при 1M msg/s = несущественно)
...
**Связанные темы:**
- [Что такое offset в Kafka](12.%20Что%20такое%20offset%20в%20Kafka.md)
...
- [Как обрабатывать ошибки при чтении сообщений](24.%20Как%20обрабатывать%20ошибки%20при%20чтении%20сообщений.md)
- [Что такое DLQ (Dead Letter Queue)](25.%20Что%20такое%20DLQ%20(Dead%20Letter%20Queue).md)
