...
**MurmurHash 2:**
- Некриптографический, быстрый. Оптимизирован под CPU-инструкции (битовые сдвиги, XOR), не требует специальных криптографических операций. В 5-10x быстрее SHA-256.
...
4. **Custom Partitioner + Key Changes:** Если кастомный партиционер использует внешние данные (например, конфигурацию из БД) для маршрутизации, и эти данные меняются — распределение становится недетерминированным. Один и тот же ключ в разных батчах попадает в разные партиции.
...
**Связанные темы:**
- [Что такое партиция (partition) и зачем она нужна](2.%20Что%20такое%20партиция%20(partition)%20и%20зачем%20она%20нужна.md)
- [Что такое ключ сообщения и как он влияет на партиционирование](4.%20Что%20такое%20ключ%20сообщения%20и%20как%20он%20влияет%20на%20партиционирование.md)
- [Что такое топик (topic) в Kafka](1.%20Что%20такое%20топик%20(topic)%20в%20Kafka.md)
- [Что такое batch в Kafka producer](21.%20Что%20такое%20batch%20в%20Kafka%20producer.md)
