...
- ISR включает в себя и самого Лидера — лидер всегда в ISR, так как он является
источником истины, ему не нужно копировать данные.
...
- [Что такое leader и follower реплики](17.%20Что%20такое%20leader%20и%20follower%20реплики.md)
- [Как Kafka обеспечивает отказоустойчивость](19.%20Как%20Kafka%20обеспечивает%20отказоустойчивость.md)
