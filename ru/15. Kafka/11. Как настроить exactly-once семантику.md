...
```
Kafka 2.5+ поддерживает EOS v2:
- Улучшенная производительность
- Меньше overhead на координацию
- Поддержка multiple consumers в одной транзакции
...
1. **Exactly-once только для Kafka-to-Kafka** — не работает с внешними системами
