...
**Связанные темы:**
- [Для чего нужны индексы](1.%20Для%20чего%20нужны%20индексы.md) → когда создавать
- [Как работает B-tree индекс](2.%20Как%20работает%20B-tree%20индекс.md) → Bloat, Page Splits
- [Что такое составной индекс](3.%20Что%20такое%20составной%20индекс.md) → консолидация индексов
- [Как оптимизировать медленные запросы](21.%20Как%20оптимизировать%20медленные%20запросы.md) → баланс индексов
