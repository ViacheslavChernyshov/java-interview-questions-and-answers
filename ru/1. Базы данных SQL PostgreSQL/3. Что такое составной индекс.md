...
**Связанные темы:**
- [Для чего нужны индексы](1.%20Для%20чего%20нужны%20индексы.md) → когда создавать индексы
- [Как работает B-tree индекс](2.%20Как%20работает%20B-tree%20индекс.md) → внутренняя структура
- [Что такое кардинальность индекса](6.%20Что%20такое%20кардинальность%20индекса.md) → порядок колонок по кардинальности
- [Какие недостатки индексов](5.%20Какие%20недостатки%20индексов.md) → стоимость записи
