...
**Связанные темы:**
- [Что такое VACUUM в PostgreSQL](18.%20Что%20такое%20VACUUM%20в%20PostgreSQL.md) → очистка dead tuples
- [Зачем нужен ANALYZE](19.%20Зачем%20нужен%20ANALYZE.md) → сбор статистики
- [Для чего нужны индексы](1.%20Для%20чего%20нужны%20индексы.md) → HOT и Visibility Map
