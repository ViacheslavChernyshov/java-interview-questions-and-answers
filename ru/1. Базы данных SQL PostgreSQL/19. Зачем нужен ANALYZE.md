...
**Когда увеличивать:**
- Колонка с аномальным распределением (Data Skew — перекос данных:
...
**Связанные темы:**
- [Что такое кардинальность индекса](6.%20Что%20такое%20кардинальность%20индекса.md) → n_distinct, MCV, correlation
- [Что такое VACUUM в PostgreSQL](18.%20Что%20такое%20VACUUM%20в%20PostgreSQL.md) → Autovacuum + ANALYZE
