...
**Связанные темы:**
- [В чём разница между INNER JOIN и LEFT JOIN](8.%20В%20чём%20разница%20между%20INNER%20JOIN%20и%20LEFT%20JOIN.md) → логические vs физические JOIN
- [Что лучше JOIN или подзапрос](9.%20Что%20лучше%20JOIN%20или%20подзапрос.md) → Semi-Join, декорреляция
- [Для чего нужны индексы](1.%20Для%20чего%20нужны%20индексы.md) → индексы на полях JOIN
- [Что такое коррелированный подзапрос](10.%20Что%20такое%20коррелированный%20подзапрос.md) → EXISTS vs JOIN
