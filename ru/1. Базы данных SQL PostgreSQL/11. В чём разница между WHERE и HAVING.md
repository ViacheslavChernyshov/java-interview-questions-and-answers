...
**Связанные темы:**
- [Что делает GROUP BY](12.%20Что%20делает%20GROUP%20BY.md) → агрегация данных
- [Когда использовать HAVING](13.%20Когда%20использовать%20HAVING.md) → практические сценарии
- [Что такое оконные функции (Window Functions)](14.%20Что%20такое%20оконные%20функции%20(Window%20Functions).md) → альтернатива HAVING для сохранения строк
