...
| **Bitmap Index Scan** | Индекс → битовая карта → строки | Средние выборки |
...
8. **SETTINGS (PG 12+)** для проверки изменённых параметров
