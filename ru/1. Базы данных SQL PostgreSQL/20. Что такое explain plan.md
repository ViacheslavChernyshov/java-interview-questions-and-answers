...
**Связанные темы:**
- [Как оптимизировать медленные запросы](21.%20Как%20оптимизировать%20медленные%20запросы.md) → практическое применение EXPLAIN
- [Зачем нужен ANALYZE](19.%20Зачем%20нужен%20ANALYZE.md) → Estimated ≠ Actual → ANALYZE
- [Что такое коррелированный подзапрос](10.%20Что%20такое%20коррелированный%20подзапрос.md) → поиск SubPlan в плане
