...
**Связанные темы:**
- [Что делает ROW_NUMBER()](15.%20Что%20делает%20ROW_NUMBER().md) → отличия от RANK
- [Что такое оконные функции (Window Functions)](14.%20Что%20такое%20оконные%20функции%20(Window%20Functions).md) → общий обзор
- [Что делает GROUP BY](12.%20Что%20делает%20GROUP%20BY.md) → NTILE как альтернатива группировке
