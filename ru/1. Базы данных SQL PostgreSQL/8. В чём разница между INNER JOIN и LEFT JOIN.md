...
**Связанные темы:**
- [Какие типы JOIN существуют](7.%20Какие%20типы%20JOIN%20существуют.md) → физические стратегии выполнения
- [Что лучше JOIN или подзапрос](9.%20Что%20лучше%20JOIN%20или%20подзапрос.md) → когда EXISTS лучше JOIN
- [Что такое коррелированный подзапрос](10.%20Что%20такое%20коррелированный%20подзапрос.md) → EXISTS как альтернатива
