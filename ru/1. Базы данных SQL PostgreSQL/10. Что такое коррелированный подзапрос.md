...
**Связанные темы:**
- [Что лучше JOIN или подзапрос](9.%20Что%20лучше%20JOIN%20или%20подзапрос.md) → Unnesting, Decorrelation
- [Какие типы JOIN существуют](7.%20Какие%20типы%20JOIN%20существуют.md) → Semi-Join, Hash Join
- [Что такое оконные функции (Window Functions)](14.%20Что%20такое%20оконные%20функции%20(Window%20Functions).md) → альтернатива для агрегации на строку
- [Что такое explain plan](20.%20Что%20такое%20explain%20plan.md) → поиск SubPlan в плане
