...
**Связанные темы:**
- [Что делает RANK() и DENSE_RANK()](16.%20Что%20делает%20RANK()%20и%20DENSE_RANK().md) → отличия от ROW_NUMBER
- [Что такое оконные функции (Window Functions)](14.%20Что%20такое%20оконные%20функции%20(Window%20Functions).md) → общий обзор
- [Что такое explain plan](20.%20Что%20такое%20explain%20plan.md) → проверка плана WindowAgg → Sort/Index Scan
