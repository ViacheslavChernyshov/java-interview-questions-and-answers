...
-- Plan:
-- Finalize GroupAggregate        ← Главный процесс объединяет
--   Gather                        ← Сбор результатов от воркеров
--     Partial GroupAggregate      ← Воркер 1: группирует свою часть
--       Parallel Seq Scan         ← Воркер 2: группирует свою часть
