...
**Связанные темы:**
- [В чём разница между WHERE и HAVING](11.%20В%20чём%20разница%20между%20WHERE%20и%20HAVING.md) → фильтрация до/после GROUP BY
- [Когда использовать HAVING](13.%20Когда%20использовать%20HAVING.md) → фильтрация по агрегатам
- [Что такое оконные функции (Window Functions)](14.%20Что%20такое%20оконные%20функции%20(Window%20Functions).md) → альтернатива для агрегации без группировки
