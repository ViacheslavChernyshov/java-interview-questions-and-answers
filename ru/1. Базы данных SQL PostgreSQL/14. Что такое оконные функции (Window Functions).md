...
**Связанные темы:**
- [Что делает ROW_NUMBER()](15.%20Что%20делает%20ROW_NUMBER().md) → уникальная нумерация
- [Что делает RANK() и DENSE_RANK()](16.%20Что%20делает%20RANK()%20и%20DENSE_RANK().md) → ранжирование
- [Что делает GROUP BY](12.%20Что%20делает%20GROUP%20BY.md) → отличие от оконных функций
