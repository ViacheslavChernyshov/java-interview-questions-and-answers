...
**Связанные темы:**
- [Для чего нужны индексы](1.%20Для%20чего%20нужны%20индексы.md) → селективность и кардинальность
- [Зачем нужен ANALYZE](19.%20Зачем%20нужен%20ANALYZE.md) → сбор статистики, n_distinct, MCV, histogram
- [Что такое составной индекс](3.%20Что%20такое%20составной%20индекс.md) → составная кардинальность
- [Как оптимизировать медленные запросы](21.%20Как%20оптимизировать%20медленные%20запросы.md) → влияние статистики на план
