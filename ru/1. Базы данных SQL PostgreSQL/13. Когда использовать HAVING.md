...
**Связанные темы:**
- [В чём разница между WHERE и HAVING](11.%20В%20чём%20разница%20между%20WHERE%20и%20HAVING.md) → порядок выполнения
- [Что делает GROUP BY](12.%20Что%20делает%20GROUP%20BY.md) → huge number of groups
- [Что такое оконные функции (Window Functions)](14.%20Что%20такое%20оконные%20функции%20(Window%20Functions).md) → почему нельзя в HAVING
