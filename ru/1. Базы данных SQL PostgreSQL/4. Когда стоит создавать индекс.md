...
**Связанные темы:**
- [Для чего нужны индексы](1.%20Для%20чего%20нужны%20индексы.md) → обзор
- [Какие недостатки индексов](5.%20Какие%20недостатки%20индексов.md) → Write Amplification
- [Что такое составной индекс](3.%20Что%20такое%20составной%20индекс.md) → консолидация
- [Как работает MVCC в PostgreSQL](17.%20Как%20работает%20MVCC%20в%20PostgreSQL.md) → HOT-обновления
