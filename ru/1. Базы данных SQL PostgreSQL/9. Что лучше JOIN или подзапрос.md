...
**Связанные темы:**
- [Какие типы JOIN существуют](7.%20Какие%20типы%20JOIN%20существуют.md) → Semi-Join, Anti-Join
- [Что такое коррелированный подзапрос](10.%20Что%20такое%20коррелированный%20подзапрос.md) → SubPlan vs InitPlan, Memoize
- [В чём разница между INNER JOIN и LEFT JOIN](8.%20В%20чём%20разница%20между%20INNER%20JOIN%20и%20LEFT%20JOIN.md) → JOIN Amplification
