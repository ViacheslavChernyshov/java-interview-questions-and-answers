...
**Связанные темы:**
- [Что такое Accept header](17.%20Что%20такое%20Accept%20header.md)
...
- [Какие HTTP статус коды вы знаете](9.%20Какие%20HTTP%20статус%20коды%20вы%20знаете.md)
- [Что такое RESTful API дизайн](11.%20Что%20такое%20RESTful%20API%20дизайн.md)
