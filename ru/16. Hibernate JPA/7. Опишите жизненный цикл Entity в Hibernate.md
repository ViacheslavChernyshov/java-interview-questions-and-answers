...
**Связанные темы:**
- [Что такое состояния transient, persistent, detached, removed](8.%20Что%20такое%20состояния%20transient%2C%20persistent%2C%20detached%2C%20removed.md)
- [Что такое dirty checking в Hibernate](12.%20Что%20такое%20dirty%20checking%20в%20Hibernate.md)
- [Как работает механизм flush в Hibernate](13.%20Как%20работает%20механизм%20flush%20в%20Hibernate.md)
- [В чём разница между persist() и merge()](14.%20В%20чём%20разница%20между%20persist()%20и%20merge().md)
- [Что такое кэш первого уровня в Hibernate](9.%20Что%20такое%20кэш%20первого%20уровня%20в%20Hibernate.md)
