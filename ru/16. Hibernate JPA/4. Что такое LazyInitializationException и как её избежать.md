...
**Связанные темы:**
- [В чём разница между Lazy и Eager загрузкой](2.%20В%20чём%20разница%20между%20Lazy%20и%20Eager%20загрузкой.md)
- [Когда использовать Lazy, а когда Eager loading](3.%20Когда%20использовать%20Lazy%2C%20а%20когда%20Eager%20loading.md)
- [Как использовать JOIN FETCH для решения проблемы N+1](28.%20Как%20использовать%20JOIN%20FETCH%20для%20решения%20проблемы%20N%2B1.md)
- [Как избежать бесконечной рекурсии при сериализации Entity](25.%20Как%20избежать%20бесконечной%20рекурсии%20при%20сериализации%20Entity.md)
