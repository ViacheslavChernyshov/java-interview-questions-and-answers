...
Почему JOIN FETCH + pagination проблематична: Hibernate не может корректно
применить LIMIT/OFFSET к запросу с JOIN — результат содержит дубликаты
root-сущностей. Count query тоже может быть неверен из-за JOIN.
Пример: LIMIT 10 на запросе с JOIN FETCH вернёт меньше 10 distinct Order.
...
- [Что делает аннотация @BatchSize](6.%20Что%20делает%20аннотация%20@BatchSize.md)
- [Какие стратегии fetch существуют в Hibernate](5.%20Какие%20стратегии%20fetch%20существуют%20в%20Hibernate.md)
- [Что такое projection в JPA](29.%20Что%20такое%20projection%20в%20JPA.md)
