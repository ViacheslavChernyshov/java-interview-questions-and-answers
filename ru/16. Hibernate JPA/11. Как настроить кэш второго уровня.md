...
spring:
  jpa:
    properties:
      ...
      jakarta.persistence.sharedCache.mode: ENABLE_SELECTIVE # (в Spring Boot 2 / Hibernate 5: javax.persistence.sharedCache.mode)
```
...
### Режимы кэширования (Jakarta Persistence / JPA)
...
jakarta.persistence.sharedCache.mode: DISABLE_SELECTIVE
...
**Связанные темы:**
- [Что такое кэш второго уровня и когда его использовать](10.%20Что%20такое%20кэш%20второго%20уровня%20и%20когда%20его%20использовать.md)
