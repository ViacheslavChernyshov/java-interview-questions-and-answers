...
spring:
  jpa:
    properties:
      ...
      jakarta.persistence.sharedCache.mode: ENABLE_SELECTIVE # (в Hibernate 5.x: javax.persistence.sharedCache.mode)
```

В Hibernate 6+ / Spring Boot 3+ используется `jakarta.persistence.sharedCache.mode`. В Hibernate 5.x — `javax.persistence.sharedCache.mode`.
...
- [Как настроить кэш второго уровня](11.%20Как%20настроить%20кэш%20второго%20уровня.md)
- [Что такое проблема N+1 и как её решить](1.%20Что%20такое%20проблема%20N%2B1%20и%20как%20её%20решить.md)
