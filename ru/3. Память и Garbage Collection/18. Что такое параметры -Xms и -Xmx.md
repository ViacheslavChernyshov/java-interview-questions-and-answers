...
**Связанные темы:**
- [В чём разница между Heap и Stack](1.%20В%20чём%20разница%20между%20Heap%20и%20Stack.md)
- [Что хранится в Heap](2.%20Что%20хранится%20в%20Heap.md)
- [Что произойдёт при OutOfMemoryError](19.%20Что%20произойдёт%20при%20OutOfMemoryError.md)
- [Какие инструменты помогают анализировать память](22.%20Какие%20инструменты%20помогают%20анализировать%20память.md)
