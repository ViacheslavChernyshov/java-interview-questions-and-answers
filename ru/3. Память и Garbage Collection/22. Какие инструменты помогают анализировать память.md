...
**Связанные темы:**
- [Что такое memory leak и как его обнаружить](21.%20Что%20такое%20memory%20leak%20и%20как%20его%20обнаружить.md)
- [Что такое heap dump](23.%20Что%20такое%20heap%20dump.md)
- [Как получить heap dump](24.%20Как%20получить%20heap%20dump.md)
- [Что произойдёт при OutOfMemoryError](19.%20Что%20произойдёт%20при%20OutOfMemoryError.md)
- [Что такое параметры -Xms и -Xmx](18.%20Что%20такое%20параметры%20-Xms%20и%20-Xmx.md)
