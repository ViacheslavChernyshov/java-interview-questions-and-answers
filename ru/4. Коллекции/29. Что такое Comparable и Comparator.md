...
**Связанные темы:**
- [В чём разница между Iterator и ListIterator](25.%20В%20чём%20разница%20между%20Iterator%20и%20ListIterator.md)
- [Какие операции поддерживает интерфейс Collection](31.%20Какие%20операции%20поддерживает%20интерфейс%20Collection.md)
