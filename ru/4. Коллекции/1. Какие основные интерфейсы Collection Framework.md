...
Iterable<E>
  └── Collection<E>
       ...
       │    ├── List<E>         ← Упорядоченный, дубликаты OK (ArrayList, LinkedList)
       │    ├── Deque<E>        ← Двусторонняя очередь (ArrayDeque)
       │    └── SequencedSet<E> ← Упорядоченное множество (LinkedHashSet, TreeSet)
       ├── Set<E>               ← Уникальные элементы (HashSet)
       └── Queue<E>             ← Очередь (PriorityQueue)
...
**Связанные темы:**
- [В чём разница между List, Set и Queue](2.%20В%20чём%20разница%20между%20List%2C%20Set%20и%20Queue.md)
- [Что такое Vector и чем он отличается от ArrayList](7.%20Что%20такое%20Vector%20и%20чем%20он%20отличается%20от%20ArrayList.md)
- [Что такое Queue и какие реализации существуют](9.%20Что%20такое%20Queue%20и%20какие%20реализации%20существуют.md)
- [Какова временная сложность операций в ArrayList](5.%20Какова%20временная%20сложность%20операций%20в%20ArrayList.md)
