...
**Связанные темы:**
- [Что такое ConcurrentModificationException](27.%20Что%20такое%20ConcurrentModificationException.md)
- [Как правильно удалять элементы во время итерации](28.%20Как%20правильно%20удалять%20элементы%20во%20время%20итерации.md)
- [Когда использовать synchronized collections](21.%20Когда%20использовать%20synchronized%20collections.md)
