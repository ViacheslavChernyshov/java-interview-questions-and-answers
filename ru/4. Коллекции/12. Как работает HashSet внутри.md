...
**Связанные темы:**
- [В чём разница между HashSet, LinkedHashSet и TreeSet](11.%20В%20чём%20разница%20между%20HashSet%2C%20LinkedHashSet%20и%20TreeSet.md)
- [Что такое Map и какие реализации существуют](14.%20Что%20такое%20Map%20и%20какие%20реализации%20существуют.md)
- [В чём разница между HashMap, LinkedHashMap и TreeMap](15.%20В%20чём%20разница%20между%20HashMap%2C%20LinkedHashMap%20и%20TreeMap.md)
- [Как ConcurrentHashMap обеспечивает thread-safety](19.%20Как%20ConcurrentHashMap%20обеспечивает%20thread-safety.md)
