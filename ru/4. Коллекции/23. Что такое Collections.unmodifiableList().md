...
**Связанные темы:**
- [Как работает Collections.unmodifiableList() внутри](24.%20Как%20работает%20Collections.unmodifiableList()%20внутри.md)
- [Как получить synchronized коллекцию](22.%20Как%20получить%20synchronized%20коллекцию.md)
