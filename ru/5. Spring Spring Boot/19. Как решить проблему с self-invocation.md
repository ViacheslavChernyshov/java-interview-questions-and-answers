...
**Связанные темы:**
- [Почему @Transactional не работает при self-invocation](18.%20Почему%20%40Transactional%20не%20работает%20при%20self-invocation.md)
...
- [В чём разница между singleton и prototype scope](12.%20В%20чём%20разница%20между%20singleton%20и%20prototype%20scope.md)
