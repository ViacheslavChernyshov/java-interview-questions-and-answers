...
> Этот вопрос детализирует этапы из файла [Что такое Bean Lifecycle](6.%20Что%20такое%20Bean%20Lifecycle.md). Если тот файл объясняет ЗАЧЕМ, то этот — КАК именно (12 шагов).
...
- [Что делают методы с аннотацией @PostConstruct и @PreDestroy](9.%20Что%20делают%20методы%20с%20аннотацией%20%40PostConstruct%20и%20%40PreDestroy.md)
