...
**Связанные темы:**
- [Что такое Repeatable Read](5.%20Что%20такое%20Repeatable%20Read.md)
- [Что такое Serializable](6.%20Что%20такое%20Serializable.md)
- [Что такое неповторяющееся чтение (Non-Repeatable Read)](8.%20Что%20такое%20неповторяющееся%20чтение%20(Non-Repeatable%20Read).md)
- [Что такое потерянное обновление (Lost Update)](10.%20Что%20такое%20потерянное%20обновление%20(Lost%20Update).md)
