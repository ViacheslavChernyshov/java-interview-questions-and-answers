...
**Почему Spring так решил:** RuntimeException = программная ошибка (NPE, IAE),
от которой невозможно восстановиться → rollback. Checked Exception = ожидаемая
бизнес-ситуация (пользователь не найден), которую вызывающий может обработать → commit.
...
- [Как настроить rollback для checked exceptions](20.%20Как%20настроить%20rollback%20для%20checked%20exceptions.md)
- [Что делает Propagation.NESTED](14.%20Что%20делает%20Propagation.NESTED.md)
- [Расшифруйте каждую букву ACID](1.%20Расшифруйте%20каждую%20букву%20ACID.md)
