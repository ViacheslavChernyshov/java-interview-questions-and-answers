...
- **Грязное чтение**: Запрещено — вы никогда не увидите незакоммиченные данные
...
3. **Минимум ошибок**: Практически не бывает принудительных откатов транзакций из-за конфликтов
