...
**Не используйте RR для:** высококонкурентных записей (>100 writers на одни данные),
длинных транзакций (>30 сек) — риск bloat и serialization failures.
...
- [Какой уровень изоляции по умолчанию в MySQL](12.%20Какой%20уровень%20изоляции%20по%20умолчанию%20в%20MySQL.md)
