...
**Связанные темы:**
- [Что такое HorizontalPodAutoscaler](15.%20Что%20такое%20HorizontalPodAutoscaler.md) — детально об HPA
- [Что такое ReplicaSet](13.%20Что%20такое%20ReplicaSet.md) — механизм репликации
- [Что такое Node в Kubernetes](10.%20Что%20такое%20Node%20в%20Kubernetes.md) — Cluster Autoscaler
