...
**Связанные темы:**
- [Что такое ReplicaSet](13.%20Что%20такое%20ReplicaSet.md) — механизм обновления
- [Что такое readiness probe](18.%20Что%20такое%20readiness%20probe.md) — блокирует удаление старых Pod'ов
- [Что такое StatefulSet и когда его использовать](23.%20Что%20такое%20StatefulSet%20и%20когда%20его%20использовать.md) — rolling update для stateful
