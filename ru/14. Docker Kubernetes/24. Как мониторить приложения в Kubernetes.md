...
**Связанные темы:**
- [Зачем нужны health checks](19.%20Зачем%20нужны%20health%20checks.md) — health endpoints для мониторинга
- [Как происходит масштабирование в Kubernetes](14.%20Как%20происходит%20масштабирование%20в%20Kubernetes.md) — custom metrics для HPA
- [Что такое Kubernetes и зачем он нужен](8.%20Что%20такое%20Kubernetes%20и%20зачем%20он%20нужен.md) — мониторинг Control Plane
