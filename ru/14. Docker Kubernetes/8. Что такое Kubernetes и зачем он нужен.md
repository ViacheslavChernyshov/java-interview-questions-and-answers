...
**Связанные темы:**
- [Что такое Pod в Kubernetes](9.%20Что%20такое%20Pod%20в%20Kubernetes.md) — минимальная единица запуска
- [Что такое Service в Kubernetes](11.%20Что%20такое%20Service%20в%20Kubernetes.md) — сетевая абстракция
- [Как происходит масштабирование в Kubernetes](14.%20Как%20происходит%20масштабирование%20в%20Kubernetes.md) — HPA, VPA, Cluster Autoscaler
