...
**Связанные темы:**
- [Что такое liveness probe](17.%20Что%20такое%20liveness%20probe.md) — проверка живучести
- [Зачем нужны health checks](19.%20Зачем%20нужны%20health%20checks.md) — все три пробы вместе
- [Как организовать rolling update в Kubernetes](22.%20Как%20организовать%20rolling%20update%20в%20Kubernetes.md) — readiness блокирует обновление
