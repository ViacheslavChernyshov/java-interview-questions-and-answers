...
**Связанные темы:**
- [Какие основные инструкции используются в Dockerfile](4.%20Какие%20основные%20инструкции%20используются%20в%20Dockerfile.md) — все инструкции Dockerfile
- [Что такое Pod в Kubernetes](9.%20Что%20такое%20Pod%20в%20Kubernetes.md) — контейнеры в K8s (signal handling важен)
- [Как организовать rolling update в Kubernetes](22.%20Как%20организовать%20rolling%20update%20в%20Kubernetes.md) — graceful shutdown при обновлении
