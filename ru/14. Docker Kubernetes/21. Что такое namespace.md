...
**Связанные темы:**
- [Что такое Kubernetes и зачем он нужен](8.%20Что%20такое%20Kubernetes%20и%20зачем%20он%20нужен.md) — объекты K8s
- [В чём разница между ConfigMap и Secret](16.%20В%20чём%20разница%20между%20ConfigMap%20и%20Secret.md) — Secrets в namespace
- [Как мониторить приложения в Kubernetes](24.%20Как%20мониторить%20приложения%20в%20Kubernetes.md) — мониторинг по namespace'ам
