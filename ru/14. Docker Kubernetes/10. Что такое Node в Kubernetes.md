...
**Связанные темы:**
- [Что такое Pod в Kubernetes](9.%20Что%20такое%20Pod%20в%20Kubernetes.md) — что запускается на Node
- [Что такое Kubernetes и зачем он нужен](8.%20Что%20такое%20Kubernetes%20и%20зачем%20он%20нужен.md) — общая архитектура
- [Как происходит масштабирование в Kubernetes](14.%20Как%20происходит%20масштабирование%20в%20Kubernetes.md) — Cluster Autoscaler
