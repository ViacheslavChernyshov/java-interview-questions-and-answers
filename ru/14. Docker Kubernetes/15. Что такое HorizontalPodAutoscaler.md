...
**Связанные темы:**
- [Как происходит масштабирование в Kubernetes](14.%20Как%20происходит%20масштабирование%20в%20Kubernetes.md) — все виды масштабирования
- [Зачем нужны health checks](19.%20Зачем%20нужны%20health%20checks.md) — startupProbe для Java warmup
- [Как мониторить приложения в Kubernetes](24.%20Как%20мониторить%20приложения%20в%20Kubernetes.md) — custom metrics для HPA
