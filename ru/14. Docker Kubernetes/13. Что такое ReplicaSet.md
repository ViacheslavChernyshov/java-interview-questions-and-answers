...
**Связанные темы:**
- [Что такое Kubernetes и зачем он нужен](8.%20Что%20такое%20Kubernetes%20и%20зачем%20он%20нужен.md) — контроллеры K8s
- [Как организовать rolling update в Kubernetes](22.%20Как%20организовать%20rolling%20update%20в%20Kubernetes.md) — Deployment + RS
- [Как происходит масштабирование в Kubernetes](14.%20Как%20происходит%20масштабирование%20в%20Kubernetes.md) — масштабирование реплик
