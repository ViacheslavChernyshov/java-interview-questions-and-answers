...
**Связанные темы:**
- [Какие основные инструкции используются в Dockerfile](4.%20Какие%20основные%20инструкции%20используются%20в%20Dockerfile.md) — детальный разбор инструкций
- [Что такое multi-stage build](6.%20Что%20такое%20multi-stage%20build.md) — оптимизация размера образа
- [В чём разница между CMD и ENTRYPOINT](5.%20В%20чём%20разница%20между%20CMD%20и%20ENTRYPOINT.md) — запуск контейнера
