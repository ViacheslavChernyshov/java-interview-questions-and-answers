...
**Связанные темы:**
- [Что такое Kubernetes и зачем он нужен](8.%20Что%20такое%20Kubernetes%20и%20зачем%20он%20нужен.md) — архитектура K8s
- [Что такое Node в Kubernetes](10.%20Что%20такое%20Node%20в%20Kubernetes.md) — где работают Pod'ы
