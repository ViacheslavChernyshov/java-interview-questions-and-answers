...
**Связанные темы:**
- [Какие типы Service существуют (ClusterIP, NodePort, LoadBalancer)](12.%20Какие%20типы%20Service%20существуют%20(ClusterIP%2C%20NodePort%2C%20LoadBalancer).md) — типы Service
- [Что такое Pod в Kubernetes](9.%20Что%20такое%20Pod%20в%20Kubernetes.md) — что стоит за Service
- [Что такое Ingress в Kubernetes](20.%20Что%20такое%20Ingress%20в%20Kubernetes.md) — L7 маршрутизация
