...
**Связанные темы:**
- [Что такое Kubernetes и зачем он нужен](8.%20Что%20такое%20Kubernetes%20и%20зачем%20он%20нужен.md) — оркестрация для продакшена
- [Что такое контейнеризация и зачем она нужна](1.%20Что%20такое%20контейнеризация%20и%20зачем%20она%20нужна.md) — основы контейнеризации
- [Как мониторить приложения в Kubernetes](24.%20Как%20мониторить%20приложения%20в%20Kubernetes.md) — monitoring для production
