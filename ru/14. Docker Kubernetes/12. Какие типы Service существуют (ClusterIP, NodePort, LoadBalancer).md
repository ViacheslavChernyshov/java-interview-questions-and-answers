...
**Связанные темы:**
- [Что такое Service в Kubernetes](11.%20Что%20такое%20Service%20в%20Kubernetes.md) — основы Service
- [Что такое Ingress в Kubernetes](20.%20Что%20такое%20Ingress%20в%20Kubernetes.md) — HTTP маршрутизация
- [Что такое Kubernetes и зачем он нужен](8.%20Что%20такое%20Kubernetes%20и%20зачем%20он%20нужен.md) — общая архитектура
