...
**Связанные темы:**
- [Что такое Dockerfile](3.%20Что%20такое%20Dockerfile.md) — основы Dockerfile
- [Какие основные инструкции используются в Dockerfile](4.%20Какие%20основные%20инструкции%20используются%20в%20Dockerfile.md) — инструкция COPY --from
- [Что такое контейнеризация и зачем она нужна](1.%20Что%20такое%20контейнеризация%20и%20зачем%20она%20нужна.md) — безопасность образов
