...
|--------|-------------------|-------------------|------------------|
| `""` | 40 bytes | 40 bytes | N/A |
| `"Hello"` | 48 bytes | 44 bytes | N/A |
...
| `"Hello"` размер | 48 bytes | 44 bytes | N/A |
...
// + entry в StringTable: ~32 bytes (native hashtable entry)
...
// sub занимает 34 bytes (UTF-16) вместо 29 bytes (Latin-1)
