...
**Связанные темы:**
- [Почему изменили реализацию substring() в Java 7](14.%20Почему%20изменили%20реализацию%20substring()%20в%20Java%207.md)
...
- [Как узнать, сколько памяти занимает String](20.%20Как%20узнать%2C%20сколько%20памяти%20занимает%20String.md)
