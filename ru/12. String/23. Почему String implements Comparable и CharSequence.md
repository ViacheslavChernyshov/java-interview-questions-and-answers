...
// Если бы String не был Comparable — использовался бы identityHashCode
// и дерево могло бы деградировать
```
...
- Без `Comparable`: fallback на `System.identityHashCode` → всё ещё уязвимость
