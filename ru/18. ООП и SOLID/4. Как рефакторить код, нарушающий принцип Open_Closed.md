...
// Почему это нарушение OCP? При добавлении GoldCustomer вам придётся
// вернуться в этот switch и добавить новый case. Вы МОДИФИЦИРУЕТЕ
// существующий код, а не расширяете.
