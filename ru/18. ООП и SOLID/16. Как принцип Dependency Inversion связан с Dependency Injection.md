...
- Каждый бин в Spring-контейнере занимает память: сам объект + прокси (CGLIB/JDK Dynamic Proxy ~1–2 КБ на прокси) + метаданные в `BeanDefinition`.
...
1. **Constructor Injection всегда** — fail-fast, final fields, JIT-friendly.
