...
- Используется **CAS** (Compare-And-Swap) для захвата
  ...
  CAS (Compare-And-Swap) — атомарная операция: «запиши новое, только если текущее = ожидаемое». Используется для thin lock захвата без блокировки ОС. Подробности — в файле [Что такое CAS (Compare-And-Swap)](9.%20Что%20такое%20CAS%20(Compare-And-Swap).md).
...
**Связанные темы:**
- [Что такое монитор (monitor) в Java](4.%20Что%20такое%20монитор%20(monitor)%20в%20Java.md)
- [В чём разница между synchronized методом и synchronized блоком](6.%20В%20чём%20разница%20между%20synchronized%20методом%20и%20synchronized%20блоком.md)
- [Что такое reentrant lock](7.%20Что%20такое%20reentrant%20lock.md)
- [Что такое CAS (Compare-And-Swap)](9.%20Что%20такое%20CAS%20(Compare-And-Swap).md)
