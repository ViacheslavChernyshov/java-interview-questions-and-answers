...
```java
// Каждый поток имеет свою копию — нет общего состояния для не-thread-safe классов
...
// 💡 В современном Java 8+ рекомендуются иммутабельные и потокобезопасные 
// классы java.time.format.DateTimeFormatter без необходимости ThreadLocal:
...
**Связанные темы:**
- [Какие условия необходимы для возникновения deadlock](18.%20Какие%20условия%20необходимы%20для%20возникновения%20deadlock.md)
- [Что такое race condition](20.%20Что%20такое%20race%20condition.md)
