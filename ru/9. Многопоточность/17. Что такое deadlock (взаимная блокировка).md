...
**Связанные темы:**
- [Как работают AtomicInteger, AtomicLong](10.%20Как%20работают%20AtomicInteger%2C%20AtomicLong.md)
- [В чём преимущество Atomic классов перед synchronized](11.%20В%20чём%20преимущество%20Atomic%20классов%20перед%20synchronized.md)
- [Что такое пул потоков (Thread Pool)](12.%20Что%20такое%20пул%20потоков%20(Thread%20Pool).md)
- [Что делает ExecutorService](14.%20Что%20делает%20ExecutorService.md)
