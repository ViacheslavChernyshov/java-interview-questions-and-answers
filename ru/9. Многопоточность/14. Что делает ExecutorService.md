...
> Детали реализации ThreadPoolExecutor (ctl, очереди, ThreadFactory) — в файле [Что такое пул потоков (Thread Pool)](12.%20Что%20такое%20пул%20потоков%20(Thread%20Pool).md).
...
**Связанные темы:**
- [Что такое пул потоков (Thread Pool)](12.%20Что%20такое%20пул%20потоков%20(Thread%20Pool).md)
- [Какие типы Thread Pool существуют в Java](13.%20Какие%20типы%20Thread%20Pool%20существуют%20в%20Java.md)
- [В чём разница между Executors.newFixedThreadPool() и newCachedThreadPool()](15.%20В%20чём%20разница%20между%20Executors.newFixedThreadPool()%20и%20newCachedThreadPool().md)
- [Что такое ForkJoinPool](16.%20Что%20такое%20ForkJoinPool.md)
