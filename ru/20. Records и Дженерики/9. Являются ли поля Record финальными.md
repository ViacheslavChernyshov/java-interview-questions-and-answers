...
- [Что такое компактный конструктор (compact constructor) в Record](7.%20Что%20такое%20компактный%20конструктор%20(compact%20constructor)%20в%20Record.md)
- [Можно ли использовать Record как ключ в HashMap](10.%20Можно%20ли%20использовать%20Record%20как%20ключ%20в%20HashMap.md)
