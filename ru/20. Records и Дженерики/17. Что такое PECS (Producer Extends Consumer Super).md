...
**Обязательно знать:**
- PECS: **P**roducer **E**xtends — читаем данные, **C**onsumer **S**uper — записываем данные
...
- [Что такое raw types и почему их следует избегать](19.%20Что%20такое%20raw%20types%20и%20почему%20их%20следует%20избегать.md)
