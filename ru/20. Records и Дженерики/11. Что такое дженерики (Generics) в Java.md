...
// Bridge Method — синтетический метод, который компилятор добавляет
// для сохранения полиморфизма после стирания типов.
...
- **Почему List<String> не наследует List<Object>?** — Дженерики инвариантны, для гибкости используются wildcards

**Красные флаги (НЕ говорить):**
- ❌ "Дженерики работают в runtime" — Type erasure удаляет типы при компиляции
- ❌ "List<String> — подтип List<Object>" — Дженерики инвариантны
...
**Связанные темы:**
- [В чём преимущества использования дженериков](12.%20В%20чём%20преимущества%20использования%20дженериков.md)
...
- [Можно ли использовать примитивные типы как параметры дженериков](18.%20Можно%20ли%20использовать%20примитивные%20типы%20как%20параметры%20дженериков.md)
