...
- [Какие методы автоматически генерируются для Record](5.%20Какие%20методы%20автоматически%20генерируются%20для%20Record.md)
- [Являются ли поля Record финальными](9.%20Являются%20ли%20поля%20Record%20финальными.md)
- [Можно ли создать массив дженерик-типа](14.%20Можно%20ли%20создать%20массив%20дженерик-типа.md)
