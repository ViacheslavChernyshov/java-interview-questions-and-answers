...
- [Что произойдёт при попытке создать экземпляр дженерик-типа через new T()](20.%20Что%20произойдёт%20при%20попытке%20создать%20экземпляр%20дженерик-типа%20через%20new%20T().md)
