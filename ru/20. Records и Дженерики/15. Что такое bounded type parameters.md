...
// JLS требует: класс (если есть) должен быть первым, т.к. erasure использует
// первый bound. В Java single inheritance — только один класс допустим.
...
- [В чём разница между <? extends T> и <? super T>](16.%20В%20чём%20разница%20между%20extends%20T%20и%20super%20T.md)
