...
public int consume() throws InterruptedException {
    ...
    try {
        while (queue.isEmpty()) {
            ...
            // потік може прокинутися БЕЗ signal(). while повторно перевірить умову.
            // Якщо використовувати if — потік продовжить роботу без реального сигналу.
            notEmpty.await(); // Чекаємо, доки з'являться дані
        }
...
**Пов'язані теми:**
- [4. Що таке монітор (monitor) в Java](4.%20%D0%A9%D0%BE%20%D1%82%D0%B0%D0%BA%D0%B5%20%D0%BC%D0%BE%D0%BD%D1%96%D1%82%D0%BE%D1%80%20(monitor)%20%D0%B2%20Java.md) — вбудований монітор vs ReentrantLock
- [5. Як працює synchronized на рівні монітора](5.%20%D0%AF%D0%BA%20%D0%BF%D1%80%D0%B0%D1%86%D1%8E%D1%94%20synchronized%20%D0%BD%D0%B0%20%D1%80%D1%96%D0%B2%D0%BD%D1%96%20%D0%BC%D0%BE%D0%BD%D1%96%D1%82%D0%BE%D1%80%D0%B0.md) — ескалація блокувань vs AQS
- [8. Що таке Atomic класи](8.%20%D0%A9%D0%BE%20%D1%82%D0%B0%D0%BA%D0%B5%20Atomic%20%D0%BA%D0%BB%D0%B0%D1%81%D0%B8.md) — AQS використовує CAS для захоплення state
- [9. Що таке CAS (Compare-And-Swap)](9.%20%D0%A9%D0%BE%20%D1%82%D0%B0%D0%BA%D0%B5%20CAS%20(Compare-And-Swap).md) — CAS — основа AQS
