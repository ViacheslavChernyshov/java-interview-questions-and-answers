...
**Так**, HashMap дозволяє використовувати **один `null` як ключа**. Якщо спробувати додати другий null-ключ, значення просто перезапишеться.
...
- [[14. Які вимоги пред'є до ключа HashMap]]
