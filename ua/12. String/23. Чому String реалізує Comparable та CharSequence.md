...
| Використовувати `compareTo` для locale-sensitive порівняння | Неправильне сортування (наприклад, специфічні символи алфавітів)                   | Використовуйте `Collator` для української/російської                 |
