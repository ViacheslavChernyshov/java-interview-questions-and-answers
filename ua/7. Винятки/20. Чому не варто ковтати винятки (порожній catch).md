...
**Пов'язані теми:**
- [18. Як правильно логовати винятки](18. Як правильно логовати винятки.md) — логування щонайменше на DEBUG
- [24. Що таке suppressed винятки](24. Що таке suppressed винятки.md) — TWR зберігає обидві помилки
- [23. Що станеться, якщо виняток виникне ще й в блоці finally](23. Що станеться, якщо виняток виникне ще й в блоці finally.md) — втрата помилки в finally
- [25. Чи можна мати кілька catch блоків для одного try](25. Чи можна мати кілька catch блоків для одного try.md) — правильна обробка різних типів
