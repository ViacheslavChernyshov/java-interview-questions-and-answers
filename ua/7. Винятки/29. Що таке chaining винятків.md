...
**Пов'язані теми:**
- [19. Що таке загортання винятків](19. Що таке загортання винятків.md) — створення ланцюжка через wrapping
- [24. Що таке suppressed винятки](24. Що таке suppressed винятки.md) — suppressed vs cause
- [16. Що таке stack trace](16. Що таке stack trace.md) — читання стек-трейсу ланцюжка
- [6. Що таке Throwable](6. Що таке Throwable.md) — поле `cause` та `initCause()`
- [17. Що робить метод printStackTrace()](17. Що робить метод printStackTrace().md) — друк всього ланцюжка з `Caused by:`
