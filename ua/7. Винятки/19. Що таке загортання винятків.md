...
**Пов'язані теми:**
- [29. Що таке chaining винятків](29. Що таке chaining винятків.md) — той самий механізм, інший ракурс
- [6. Що таке Throwable](6. Що таке Throwable.md) — поле `cause` та `initCause()`
- [17. Що робить метод printStackTrace()](17. Що робить метод printStackTrace().md) — як побачити ланцюжок у логах
- [16. Що таке stack trace](16. Що таке stack trace.md) — читання стек-трейсу з `Caused by:`
- [18. Як правильно логовати винятки](18. Як правильно логовати винятки.md) — логування з `%ex`
