...
**Пов'язані теми:**
- [23. Що станеться, якщо виняток виникне ще й в блоці finally](23. Що станеться, якщо виняток виникне ще й в блоці finally.md) — затьмарення без suppressed
- [9. Що таке try-with-resources](9. Що таке try-with-resources.md) — основний сценарій використання
- [19. Що таке загортання винятків](19. Що таке загортання винятків.md) — cause vs suppressed
- [29. Що таке chaining винятків](29. Що таке chaining винятків.md) — cause (причина) vs suppressed (паралельна помилка)
- [11. Що таке AutoCloseable інтерфейс](11.%20%D0%A9%D0%BE%20%D1%82%D0%B0%D0%BA%D0%B5%20%D1%96%D0%BD%D1%82%D0%B5%D1%80%D1%84%D0%B5%D0%B9%D1%81%20AutoCloseable.md) — ресурси з suppressed при закритті
