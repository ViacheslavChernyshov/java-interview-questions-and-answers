...
**Пов'язані теми:**
- [21. Що робить ключове слово throws](21. Що робить ключове слово throws.md) — стандартний механізм оголошення винятків
- [19. Що таке загортання винятків](19. Що таке загортання винятків.md) — обгортка як альтернатива
- [3. Що таке unchecked exception (Runtime Exception)](3. Що таке unchecked exception (Runtime Exception).md) — unchecked не потребують `throws`
- [28. Чи можна перехопити і викинути виняток заново](28. Чи можна перехопити і викинути виняток заново.md) — rethrow та sneaky throws
