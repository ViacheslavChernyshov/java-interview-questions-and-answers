...
**Пов'язані теми:**
- [19. Що таке загортання винятків](19. Що таке загортання винятків.md) — обгортка при rethrow
- [21. Що робить ключове слово throws](21. Що робить ключове слово throws.md) — Precise Rethrow зберігає типи
- [29. Що таке chaining винятків](29. Що таке chaining винятків.md) — chaining при обгортці з cause
- [22. Чи можна викинути checked виняток з методу без throws](22. Чи можна викинути checked виняток з методу без throws.md) — sneaky throws альтернатива
- [18. Як правильно логовати винятки](18. Як правильно логовати винятки.md) — логування перед rethrow
