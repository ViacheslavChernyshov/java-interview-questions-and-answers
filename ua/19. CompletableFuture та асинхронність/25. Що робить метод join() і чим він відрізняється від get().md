...
**Головна відмінність:**
- **`get()`** — викидає **checked виняток** (`InterruptedException`, `ExecutionException`)
...
**get() — коли потрібні checked виняток:**
```java
try {
...
- Внутрішньо однакові — різниця тільки в типі виняток
...
- «get() і join() повністю ідентичні» — різні типи винятків, get має таймаут
