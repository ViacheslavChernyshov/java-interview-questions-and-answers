...
class CompletableFuture<T> {
    ...
    // AltResult — внутрішній JDK-клас-обгортка для винятків.
    // Дозволяє зберігати null як валідний результат і відрізняти його від виняток.
...
```java
// виняток загортається в CompletionException
CompletableFuture.supplyAsync(() -> {
...
- «Ігнорую CompletableFuture не обробляючи» — втрачене виняток
