...
16 питань для підготовки до співбесіди на Junior 🟢, Middle 🟡 та Senior 🔴 Java Developer.
...
|---|---|---|
| 1 | [Що таке патерни проектування](01.%20Що%20таке%20патерни%20проектування.md) | ⭐ |
| 2 | [Які категорії патернів існують](02.%20Які%20категорії%20патернів%20існують.md) | ⭐ |
| 3 | [Що таке Singleton](03.%20Що%20таке%20Singleton.md) | ⭐⭐ |
| 4 | [Як реалізувати потокобезпечний Singleton](04.%20Як%20реалізувати%20потокобезпечний%20Singleton.md) | ⭐⭐⭐ |
| 5 | [Що таке double-checked locking](05.%20Що%20таке%20double-checked%20locking.md) | ⭐⭐⭐ |
| 6 | [Які проблеми є у Singleton](06.%20Які%20проблеми%20є%20у%20Singleton.md) | ⭐⭐ |
| 7 | [У чому різниця між Factory Method та Abstract Factory](07.%20У%20чому%20різниця%20між%20Factory%20Method%20та%20Abstract%20Factory.md) | ⭐⭐ |
| 8 | [Коли використовувати Builder](08.%20Коли%20використовувати%20Builder.md) | ⭐⭐ |
| 9 | [Що таке патерн Prototype](09.%20Що%20таке%20патерн%20Prototype.md) | ⭐⭐ |
| 10 | [Коли використовувати Strategy](10.%20Коли%20використовувати%20Strategy.md) | ⭐⭐⭐ |
| 11 | [Як Observer реалізований у Java](11.%20Як%20Observer%20реалізований%20у%20Java.md) | ⭐⭐ |
| 12 | [У чому переваги Decorator перед успадкуванням](12.%20У%20чому%20переваги%20Decorator%20перед%20успадкуванням.md) | ⭐⭐ |
| 13 | [У чому різниця між State та Strategy](13.%20У%20чому%20різниця%20між%20State%20та%20Strategy.md) | ⭐⭐⭐ |
...
```
            ...
            ▼                          ▼                          ▼
    ┌───────────────┐        ┌───────────────┐        ┌────────────────────┐
    │ ПОРОДЖУВАЛЬНІ │        │ ПОВЕДІНКОВІ   │        │ СТРУКТУРНІ         │
...
| 3 | Factory та Builder | Q7, Q8 | Створення об'єктів |
| 4 | Decorator та Iterator | Q12, Q15 | Обгортання, перебір |
...
**Ключові зв'язки:**
- Q4 ↔ Q5: DCL — один зі способів thread-safe Singleton
- Q6 ↔ Q3: DI-контейнер (Spring) вирішує проблеми Singleton

### Тема: Породжувальні патерни
...
- 3 категорії: породжувальні, структурні, поведінкові
...
- Decorator vs успадкування: n декораторів замість 2^n класів

### 🔴 Senior
- JMM: volatile = happens-before гарантія, DCL без volatile = broken
- Megamorphic call threshold = 5 у HotSpot, inline cache оптимізація
