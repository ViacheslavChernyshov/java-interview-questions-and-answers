# У чому різниця між Factory Method та Abstract Factory?
...
// Пов'язаних = вони мають бути з однієї «сім'ї» (всі Windows-компоненти або всі Mac-компоненти),
...
**Механізм:** Успадкування (підкласи вирішують)
...
- Важливо, щоб об'єкти були з одного сімейства
...
```java
// Додати новий тип → новий підклас (не змінюємо існуючий код)
...
**Simple Factory** = статичний метод. Не можна розширити успадкуванням.
...
**Factory Method:**
```
Monomorphic call (1 підклас) → інлайнінг
Bimorphic call (2 підкласи) → все ще швидко  
Megamorphic call (>2 підкласів) → непрямий виклик
```
...
Накладні витрати: 2 віртуальних виклики замість 1
```

### Production Experience

**Реальний сценарій: Abstract Factory врятував від mixing**
- UI фреймворк: Windows та Mac теми
...
- **Factory Method** = успадкування, один продукт, OCP-friendly
...
**Обов'язково знати:**
- Factory Method створює один продукт через успадкування, Abstract Factory — сімейство продуктів через композицію
...
- **Коли вибрати Factory Method, а коли Abstract Factory?** — Один продукт = Factory Method, сімейство пов'язаних = Abstract Factory
...
- ❌ «Factory Method та Abstract Factory — це одне й те саме» — принципово різні механізми та цілі
...
**Пов'язані теми:**
- [Коли використовувати Builder](08.%20Як%20реалізувати%20Builder.md) — породжувальний патерн для складних об'єктів
- [Що таке патерн Prototype](09.%20Що%20таке%20патерн%20Prototype.md) — породжувальний патерн копіювання
...
- [Як працює Strategy](10.%20Як%20працює%20Strategy.md) — поведінковий патерн, альтернатива через композицію
